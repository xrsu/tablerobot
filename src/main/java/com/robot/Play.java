...
public class Play {
	...
	/*
	 * @SuppressWarnings("unused") private int table[][] = new
	 * int[Constants.MAX_UNITS][Constants.MAX_UNITS];
	 */
	...
	public void executeCommand(String command) {
		...
		ICommand commandInst = CommandFactory.getInstance(
				commandObj.getCommand(), commandObj.getCommandParams(),
				robotInfo);
		if (commandInst != null) {
			commandInst.execute();
		}
